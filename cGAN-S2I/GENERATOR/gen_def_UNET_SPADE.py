...
class SPADE(nn.Module):
    def __init__(self, norm_nc, label_nc):
        ...
        # Projection layers from the input segmentation map to the modulation parameters
    ...
    def forward(self, x, segmap):
        # Resize segmap to match x's spatial dimensions
...
# Standard DownBlock with InstanceNorm instead of SPADE
...
# SPADE-augmented U-Net Generator
